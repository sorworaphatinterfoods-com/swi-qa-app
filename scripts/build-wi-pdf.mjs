...
const DOC_LABELS = {
  ...
  'SD-product-grouping': 'ตารางจัดกลุ่มผลิตภัณฑ์และเหตุผลการใช้ผลิตภัณฑ์ตัวแทน · ฉบับร่าง ยังไม่ผ่านการอนุมัติ',
  'HA-worksheet-step8-15': 'ใบงานวิเคราะห์อันตราย ขั้นตอนที่ 8 และ 15 · สำหรับการประชุมคณะทำงาน HACCP',
  'GHP-start-kit': 'แผนเริ่มบันทึกทะเบียน GHP และแบบเดินสำรวจแก้ว/พลาสติกแข็ง',
  'QP-QA-04-frequency-worksheet': 'ใบกรอกความถี่และเกณฑ์ที่ยังไม่กำหนด สำหรับร่าง QP-QA-04 Rev.03 · ใบงาน ไม่ใช่บันทึกควบคุม',
};
